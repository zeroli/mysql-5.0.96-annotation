...
my $ldata   = 'C:/Program Files (x86)/MySql/MySQL Server /data';
my $execdir = 'C:/Program Files (x86)/MySql/MySQL Server /bin';
my $bindir  = 'C:/Program Files (x86)/MySql/MySQL Server /bin';
...
$flags->{cflags}  = [@{$flags->{include}},split(" ",'-D_WINDOWS /MT /Zi /O2 /Ob1 /DNDEBUG -DDBUG_OFF /wd4996')];
