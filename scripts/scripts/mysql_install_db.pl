...
{
  $print_defaults='C:/Program Files (x86)/MySql/MySQL Server /bin/my_print_defaults';
}
...
{
  $opt->{basedir} = 'C:/Program Files (x86)/MySql/MySQL Server ';
  $bindir         = 'C:/Program Files (x86)/MySql/MySQL Server /bin';
  $extra_bindir   = $bindir;
  $mysqld         = 'C:/Program Files (x86)/MySql/MySQL Server /bin/mysqld';
  $pkgdatadir     = 'C:/Program Files (x86)/MySql/MySQL Server /share';
  $scriptdir      = 'C:/Program Files (x86)/MySql/MySQL Server /bin';
}

unless ( $opt->{ldata} )
{
  $opt->{ldata} = 'C:/Program Files (x86)/MySql/MySQL Server /data';
}
  ...
  if ( !$opt->{'cross-bootstrap'} )
  {
    ...
    if ( !$opt->{rpm} )
    {
      report($opt,
             ...
             "",
             "  cd " . 'C:/Program Files (x86)/MySql/MySQL Server ' . " ; $bindir/mysqld_safe &",
             "",
    ...
    report($opt,
           "Please report any problems with the " . 'C:/Program Files (x86)/MySql/MySQL Server /bin' . "/mysqlbug script!",
           "",
...
else
{
  error($opt,
        ...
        "And if you do mail us, you MUST use the " . 'C:/Program Files (x86)/MySql/MySQL Server /bin' . "/mysqlbug script!")
}
